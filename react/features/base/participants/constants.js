...
export const CLAP_SOUND_IDS = [
    'PARTICIPANT_CLAPPED_SOUND_1',
    'PARTICIPANT_CLAPPED_SOUND_2',
    'PARTICIPANT_CLAPPED_SOUND_3',
    'PARTICIPANT_CLAPPED_SOUND_4',
    'PARTICIPANT_CLAPPED_SOUND_5'
];


export const MALE_LAUGH_SOUND_IDS = [
    'MALE_PARTICIPANT_LAUGHED_SOUND_1',
    'MALE_PARTICIPANT_LAUGHED_SOUND_2',
    'MALE_PARTICIPANT_LAUGHED_SOUND_3',
    'MALE_PARTICIPANT_LAUGHED_SOUND_4',
    'MALE_PARTICIPANT_LAUGHED_SOUND_5'
];


export const FEMALE_LAUGH_SOUND_IDS = [
    'FEMALE_PARTICIPANT_LAUGHED_SOUND_1',
    'FEMALE_PARTICIPANT_LAUGHED_SOUND_2',
    'FEMALE_PARTICIPANT_LAUGHED_SOUND_3',
    'FEMALE_PARTICIPANT_LAUGHED_SOUND_4',
    'FEMALE_PARTICIPANT_LAUGHED_SOUND_5'
];


export const WHISTLE_SOUND_IDS = [
    'PARTICIPANT_WHISTLED_SOUND_1',
    'PARTICIPANT_WHISTLED_SOUND_2',
    'PARTICIPANT_WHISTLED_SOUND_3',
    'PARTICIPANT_WHISTLED_SOUND_4',
    'PARTICIPANT_WHISTLED_SOUND_5'
];


export const MALE_BOO_SOUND_IDS = [
    'MALE_PARTICIPANT_BOOED_SOUND_1',
    'MALE_PARTICIPANT_BOOED_SOUND_2',
    'MALE_PARTICIPANT_BOOED_SOUND_3',
    'MALE_PARTICIPANT_BOOED_SOUND_4',
    'MALE_PARTICIPANT_BOOED_SOUND_5'
];


export const FEMALE_BOO_SOUND_IDS = [
    'FEMALE_PARTICIPANT_BOOED_SOUND_1',
    'FEMALE_PARTICIPANT_BOOED_SOUND_2',
    'FEMALE_PARTICIPANT_BOOED_SOUND_3',
    'FEMALE_PARTICIPANT_BOOED_SOUND_4',
    'FEMALE_PARTICIPANT_BOOED_SOUND_5'
];